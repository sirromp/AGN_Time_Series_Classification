...
cut_flag = 0 #set to one to only use fraction cut_val of data (for speed purposes)
...
def model2(input_shape):
    ...
    conv1 = keras.layers.Conv1D(filters=28, kernel_size=3, padding="same")(input_layer)
    conv1 = keras.layers.BatchNormalization()(conv1)
    conv1 = keras.layers.ReLU()(conv1)
